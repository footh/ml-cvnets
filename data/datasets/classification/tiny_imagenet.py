...
@register_dataset(name="tinyimagenet", task="classification")
class TinyImagenetDataset(BaseImageDataset, ImageFolder):
    """
        Dataset class for the Tiny ImageNet dataset.
        ...
        + imagenet
          ...
          |- validation
             |- n*
        Both validation and training will have 200 folders starting with 'n' (1 folder per class).
    """
    ...
    def validation_transforms(self, size: tuple):
        ...
        # (256 - 224) = 32
        # where 224/0.875 = 256
        scale_size = size + 8  # int(make_divisible(crop_size / 0.875, divisor=32))
